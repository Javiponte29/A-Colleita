    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className={`fixed inset-y-0 left-0 bg-white shadow-lg w-64 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out z-50`}>
        <div className="p-6">
          ...
          <button onClick={handleLogout} className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 focus:outline-none">Cerrar sesión</button>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white shadow p-4 flex justify-between items-center">
          ...
          <button onClick={toggleSidebar} className="bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-700 focus:outline-none">Abrir Menú</button>
        </header>
