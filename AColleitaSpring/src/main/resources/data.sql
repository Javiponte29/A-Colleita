...
(1, 'Maíz', 4, 'Mazaricos, 15258, La Coruña', 8, 10, 1, 'Maíz fresco, jugoso y lleno de sabor, ideal para una variedad de usos culinarios. 
...
(2, 'Repollo', 4, 'Lugar Todon, 5', 9, 12, 1, 'Cultivados con esmero, seleccionando cuidadosamente las mejores variedades para ofrecerte la 
...
(3, 'Cebolla Blanca', 4, 'Finca Horticina', 7, 10, 1, 'Seleccionamos cuidadosamente cebollas de la más alta calidad para garantizarte una 
experiencia culinaria excepcional.', 'https://familia.freshcatarina.com/uploads/Cebolla-blanca-02.png'),
(4, 'Judías Verdes', 4, 'Celanova, Ourense', 8, 10, 1, 'Las judías verdes son mucho más que un simple vegetal: son un complemento versátil y 
...
(5, 'Grelos', 4, 'Ramirás, Ourense', 7, 10, 1, '¡Sumérgete en la tradición y el sabor único de nuestros grelos frescos en nuestro mercado! Los 
...
(6, 'Patatas', 4, 'As Quintas Nº11 Burres Arzúa, A Coruña', 7, 10, 1, '¡Deleita tu paladar con la calidad y la frescura incomparables de nuestras 
...
(7, 'Fabas', 4, 'A Codeseira Arzúa, La Coruña', 6, 10, 1, '¡Explora la auténtica tradición culinaria con nuestras fabas frescas en nuestro 
...
(8, 'Setas', 4, 'Mercurín Boimorto, La Coruña', 10, 10, 1, '¡Sumérgete en el mundo de las setas frescas en nuestro mercado! Seleccionadas con 
...
(10, 'Manzana Verde', 4, 'Forcarei, Pontevedra', 9, 10, 2, '¡Sumérgete en la frescura y el sabor vibrante de nuestras manzanas verdes en nuestro 
...
(11, 'Naranja', 4, 'A Estrada, Pontevedra', 7, 10, 2, '¡Explora la frescura y el sabor cítrico de nuestras jugosas naranjas en nuestro mercado! 
...
(13, 'Limón', 4, 'Padrón, La Coruña', 9, 10, 2, '¡Experimenta la frescura y el sabor vibrante de nuestros limones en nuestro mercado! Cultivados 
...
(14, 'Kiwi', 4, 'Teo, La Coruña', 6, 10, 2, '¡Descubre la frescura y el sabor exótico de nuestros kiwis en nuestro mercado! Provenientes de los 
...
(15, 'Pera', 4, 'Brión, La Coruña', 8, 10, 2, '¡Explora la dulzura y la jugosidad de nuestras peras en nuestro mercado! Seleccionadas 
...
(16, 'Queso de Arzúa', 4, 'Riva Pantiñobre, A Coruña', 9, 10, 3, 'El queso de Arzúa es más que un simple lácteo: es el resultado de una 
...
(17, 'Queso Curado de oveja', 4, 'O Seixo Santiso, Pontevedra', 10, 10, 3, '¡Sumérgete en la rica tradición y el delicioso sabor de 
...
(18, 'Queso Galmesán', 4, 'Teiraboa, A Coruña', 9, 10, 3, 'El queso Galmesán es una obra maestra artesanal que fusiona la riqueza de los 
...
(19, 'Queso do cebreiro', 4, 'San Andrés de Barredo, Lugo', 9, 10, 3, 'Con una textura cremosa y suave que se desliza delicadamente 
...
(20, 'Queso Da Josefa', 4, 'Palas del Rey, Lugo', 8, 10, 3, 'Con una textura suave y untuosa que se deshace delicadamente en el paladar, el 
...
(21, 'Leche Entera', 4, 'A Lamea, La Coruña', 6, 10, 3, '¡Experimenta la frescura y la bondad natural de nuestra leche entera en cada sorbo! 
...
(22, 'Leche sin Lactosa', 4, 'A Lamea, La Coruña', 7, 10, 3, 'Descubre la frescura y la suavidad de nuestra leche sin lactosa, una opción perfecta 
...
(25, 'Licor Café', 4, 'Teimende, Ourense', 9, 10, 4, 'Nuestro Licor de Café cautiva con su aroma tentador a café recién tostado y su sabor suave 
...
(26, 'Aguardiente', 4, 'A Seara, Pontevedra', 8, 10, 4, 'Con su aroma tentador y su sabor distintivo, nuestra Aguardiente cautiva los sentidos 
...
(27, 'Licor Guindas', 4, 'Ferrol, A Coruña', 8, 10, 4, 'Nuestro Licor de Guindas es una verdadera obra maestra, con un aroma embriagador que te 
...
(29, 'Zumo de naranja', 4, 'Foz, Lugo', 8, 10, 4, 'El jugo se extrae cuidadosamente de las naranjas más maduras y jugosas, preservando su frescura 
...
(30, 'Zumo espumoso de manzana', 4, 'Pardeconde Xunqueira de Espadanedo, Ourense', 7, 10, 4, 'Nuestro zumo espumoso se elabora con cuidado a 
...
(31, 'Vino Tinto Tesouro', 4, 'Cachamuíña, Ourense', 8, 10, 4, 'Sumérgete en la riqueza y la elegancia del Vino Tinto Tesouro, una verdadera 
...
(32, 'Aguacate', 4, 'Forcarei, Pontevedra', 10, 10, 2, '¡Sumérgete en la frescura y el sabor vibrante de nuestros aguacates en nuestro 
